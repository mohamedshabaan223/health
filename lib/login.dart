        ...
        child: Column(
         // mainAxisAlignment: MainAxisAlignment.center,
          ...
          children: [
            ...
            DefaultTextformfield(hint: 'Enter Email', controller: emailController),
            SizedBox(height: height *0.03,),
            Text('Password' , style: Theme.of(context).textTheme.titleLarge,),
             SizedBox(height: height*0.02,),
            DefaultTextformfield(hint: 'Enter Password', controller: passwordController,
            isPassword: true,
            ),
             Row(children: [
              Spacer(),
             ...
             Center(child: DefaultElvatedbutton(label: 'Login', onPressed: (){})),
             SizedBox(height: height* 0.02,),
             Center(child: Text('or sign up with' , 
             style: Theme.of(context).textTheme.titleSmall)),
             Row(mainAxisAlignment: MainAxisAlignment.center,
              children: [
              IconButton(onPressed: (){}, icon: Icon(Icons.facebook_outlined , size: 60 , color: AppTheme.green,)),
               IconButton(onPressed: (){}, icon: Icon(Icons.fingerprint , size: 60 , color: AppTheme.green,)),
             ]),
             Row(
            mainAxisAlignment: MainAxisAlignment.center,
              children: [
