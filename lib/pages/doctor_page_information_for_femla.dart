...
class DoctorPageInformationForFemla extends StatefulWidget {
  static const String routeName = '/doctor-info-female';

  const DoctorPageInformationForFemla({super.key});

  @override
  State<DoctorPageInformationForFemla> createState() =>
      _DoctorInformationForFemlaState();
}

class _DoctorInformationForFemlaState
    extends State<DoctorPageInformationForFemla> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() {
