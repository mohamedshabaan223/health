...
class DoctorPageInformationForRating extends StatefulWidget {
  static const String routeName = '/doctor-info-for-rating';

  const DoctorPageInformationForRating({super.key});

  @override
  State<DoctorPageInformationForRating> createState() =>
      _DoctorInformationForRatingState();
}

class _DoctorInformationForRatingState
    extends State<DoctorPageInformationForRating> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() {
