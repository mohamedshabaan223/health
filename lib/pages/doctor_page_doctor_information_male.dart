...
class DoctorPageInformationForMale extends StatefulWidget {
  static const String routeName = '/doctor-info-male';

  const DoctorPageInformationForMale({super.key});

  @override
  State<DoctorPageInformationForMale> createState() =>
      _DoctorInformationForMaleState();
}

class _DoctorInformationForMaleState
    extends State<DoctorPageInformationForMale> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() {
