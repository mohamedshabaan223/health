...
class ContainerCompleteDoctor extends StatefulWidget {
  ...
  @override
  State<ContainerCompleteDoctor> createState() => _ContainerCompleteDoctorState();
}
          ...
          Row(
            ...
            children: [
              InkWell(
                ...
                child: Text('Re-Book' , style: Theme.of(context).textTheme.titleLarge?.copyWith(color: AppTheme.green),),),
              ),
               InkWell(
                onTap: (){},
                 child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(18)
                               ...
                               child: Text('Add Review' , style: Theme.of(context).textTheme.titleLarge?.copyWith(color: AppTheme.white),),),
               ),
            ],
          )
        ],
