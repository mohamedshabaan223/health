...
class ContainerAllDoctor extends StatefulWidget {
  ...
  @override
  State<ContainerAllDoctor> createState() => _ContainerDoctorFemaleState();
}

class _ContainerDoctorFemaleState extends State<ContainerAllDoctor> {
  late int patientId;
